...
define i32 @fptr_driver() local_unnamed_addr #2 {
  ...
  store volatile i32 (i32, i32)* @foo, i32 (i32, i32)** %1, align 8, !tbaa !3
  %3 = tail call i32 @calls_fptr(i32 (i32, i32)* nonnull @foo, i32 10)
...
define i32 @struct_driver() local_unnamed_addr #2 {
  ...
  %3 = getelementptr inbounds %struct.StructWithFuncPtr, %struct.StructWithFuncPtr* %1, i64 0, i32 1
  store volatile i32 (i32, i32)* @foo, i32 (i32, i32)** %3, align 8, !tbaa !7
  %4 = getelementptr inbounds %struct.StructWithFuncPtr, %struct.StructWithFuncPtr* %1, i64 0, i32 0
  store volatile i32 3, i32* %4, align 8, !tbaa !10
  %5 = call i32 @calls_through_struct(%struct.StructWithFuncPtr* nonnull %1)
